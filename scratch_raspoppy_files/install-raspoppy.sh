...
sed -i "s/$search1/$replace1/" ~/dev/snap/scratch-gui/src/lib/librairies/extensions/index.jsx
...
sed -i "s/$search2/$replace2/" ~/dev/snap/scratch-gui/src/lib/librairies/extensions/index.jsx
...
sed -i "s/$search3/$replace3/" ~/dev/snap/scratch-vm/src/blocks/scratch3_data.js
search4="deleteOfList (args, util) {"
replace4="}\n\n    deleteOfList (args, util) {"
sed -i "s/$search4/$replace4/" ~/dev/snap/scratch-vm/src/blocks/scratch3_data.js

cp -r ~/dev/snap/scratch-poppy/scratch_vm_files/scratch3_poppy ~/dev/snap/scratch-vm/src/extensions
cp -r ~/dev/snap/scratch-poppy/scratch_gui_files/poppy ~/dev/snap/scratch-gui/src/lib/librairies/extensions
